...
const HomePage = () => {
  ...
  return (
    <>
      <div className='bg-primary text-white dark:bg-white dark:text-primary px-8 max-md:px-2 w-screen grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5'>
        {products.length === 0 ? (
